...
reportModel.payroll = async (data) => {
    ...
    "emp.emp_lastname,emp.emp_middle_name,emp.emp_number,emp.employee_id,potong.pemot_nama,potong.pemot_type,potong.pemot_byr_karyawan,potong.pemot_byr_company,"+
